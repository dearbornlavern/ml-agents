...
class UnityRLInput(google___protobuf___message___Message):
    ...
    class ListAgentActionProto(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: builtin___bytes) -> UnityRLInput.ListAgentActionProto: ...
    ...
    class AgentActionsEntry(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: builtin___bytes) -> UnityRLInput.AgentActionsEntry: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    @classmethod
    def FromString(cls, s: builtin___bytes) -> UnityRLInput: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
