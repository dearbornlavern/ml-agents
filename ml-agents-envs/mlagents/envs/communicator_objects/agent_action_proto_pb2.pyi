...
class AgentActionProto(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        debug : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"custom_action",u"debug",u"memories",u"text_actions",u"value",u"vector_actions"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"custom_action",b"custom_action"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"custom_action",b"custom_action",u"debug",b"debug",u"memories",b"memories",u"text_actions",b"text_actions",u"value",b"value",u"vector_actions",b"vector_actions"]) -> None: ...
